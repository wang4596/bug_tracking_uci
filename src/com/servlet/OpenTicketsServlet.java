...
//This servlet will query the database for all open tickets.
public class OpenTicketsServlet extends HttpServlet {
	private static final long serialVersionUID = 2L;
	private static Logger log = Logger.getLogger(LoginServlet.class.getName());

	public OpenTicketsServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		String sqlQuery = "SELECT Id,Summary,Status,ProjectName,Priority,Assignee FROM BugTracker.Tickets WHERE status='Open';";
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/OpenTickets.jsp");
